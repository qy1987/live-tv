...
about_video1="https://gcalic.v.myalicdn.com/gc/wgw05_1/index.m3u8?contentid=2820180516001"
...
all_lines =  ["更新时间,#genre#"] +[version]  +[about] +read_txt_to_array('专区/about.txt') + ['\n'] +\
             ...
             ["山东频道,#genre#"] + sort_data(shandong_dictionary,set(correct_name_data(corrections_name,shandong_lines))) + ['\n'] + \
